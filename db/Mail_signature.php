...
private static $MAIL_RSA_PASSPHRASE = 'quanterp';
private static $MAIL_RSA_PRIV = 
'-----BEGIN RSA PRIVATE KEY-----
Proc-Type: 4,ENCRYPTED
DEK-Info: DES-EDE3-CBC,639E0532C155C0F9


-----END RSA PRIVATE KEY-----';
private static $MAIL_RSA_PUBL = //added as a DNS TXT record for quanterp.com on 15/05/2018
'-----BEGIN PUBLIC KEY-----
MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDEwl2RXYzOXndeaPl75NWuXMvQ
GzlHu/+PLutSJHAflzv8OI37H7FHSAt64ZiDL/fLzkrxfkRnKwpzAFxv3aK5G8Ej
KayHszCvh/97cikjoQrZHBl/p8lbyg/w5EbnpHlccKAcpXTGY5IOAPfnRJ+dnOqu
2G+BjvD0ZZIdn42N2QIDAQAB
-----END PUBLIC KEY-----';
// Domain or subdomain of the signing entity (i.e. the domain where the e-mail comes from)
private static $MAIL_DOMAIN = 'quanterp.com';  
...
private $canonicalized_headers_relaxed;
	...
	//public function my_construct($private_key, $passphrase, $domain, $selector, $options = array()){
        public function initialize(){
            
            
                $private_key = self::$MAIL_RSA_PRIV;
                $passphrase = self::$MAIL_RSA_PASSPHRASE;
                $domain = self::$MAIL_DOMAIN;
                $selector = self::$MAIL_SELECTOR;
                $options = array();
