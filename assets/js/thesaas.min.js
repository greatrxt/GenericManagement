...
function recaptchaCallback() {
    ...
    c.defaults = {
        ...
        if (a.extend(!0, c.defaults, d), c.defaults.smoothScroll || SmoothScroll.destroy(), a('[data-provide~="map"]').length && void 0 === b["google.maps.Map"] && a.getScript("https://maps.googleapis.com/maps/api/js?key=" + c.defaults.googleApiKey + "&callback=thesaas.map"), c.defaults.googleAnalyticsId && (! function(a, b, c, d, e, f, g) {
            ...
            }(b, document, "script", 0, "ga"), ga("create", c.defaults.googleAnalyticsId, "auto"), ga("send", "pageview")), a('[data-provide~="recaptcha"]').length && void 0 === b.grecaptcha) {
            var e = "https://www.google.com/recaptcha/api.js?onload=recaptchaCallback";
            "" != c.defaults.reCaptchaLanguage && (e += "&hl=" + c.defaults.reCaptchaLanguage), a.getScript(e)
        }
    }, c.init = function() {
        c.topbar(), c.parallax(), c.carousel(), c.scrolling(), c.counter(), c.aos(), c.typed(), c.contact(), c.mailer(), c.constellation(), c.shuffle(), c.bindValue(), a(document).on("click", '[data-provide~="lightbox"]', lity), objectFitPolyfill(a(".bg-video")), a(document).on("click", ".video-wrapper .btn", function() {
    ...
    }, c.recaptcha = function() {
        a('[data-provide~="recaptcha"]').each(function() {
            var b = {
                sitekey: c.defaults.reCaptchaSiteKey
            };
            b = a.extend(b, c.getDataOptions(a(this))), grecaptcha.render(a(this)[0], b)
        })
    }, c.carousel = function() {
        ...
        a("[data-type]").each(function() {
            ...
            d = a.extend(d, c.getDataOptions(a(this)));
            new Typed(a(this)[0], d)
        })
    }, c.contact = function() {
        ...
        a('[data-form="mailer"]').each(function() {
            var c = a(this),
                ...
                p = c.find('[name="phone"]'),
                h = p.closest(".form-group"),
                f = d.closest(".form-group"),
                g = e.closest(".form-group");
            c.on("submit", function() {
                return c.children(".alert-danger").remove(), 
                       //d.length && (d.val().length < 1 || !b.test(d.val())) ? (f.addClass("has-danger"), !1) : 
                            p.length && p.val().length < 1 ? (h.addClass("has-danger"), !1) :     
                            e.length && e.val().length < 1 ? (g.addClass("has-danger"), !1) : (a.ajax({
                    type: "POST",
                    url: c.attr("action"),
        ...
        a(b).width() < 700 && (d = 25), a(".constellation").each(function() {
            "dark" == a(this).data("color") && (c = "rgba(0, 0, 0, .5)");
            var b = a(this).dataAttr("length", 100),
                e = a(this).dataAttr("radius", 150);
            a(this).constellation({
                distance: d,
                length: b,
                radius: e,
                star: {
            ...
            c.options.itemSelector = '[data-shuffle="item"]', c.options.sizer = '[data-shuffle="sizer"]', c.options.delimeter = ",", c.options.speed = 500, a('[data-provide="shuffle"]').each(function() {
                ...
                d.length && a(d).find('[data-shuffle="button"]').each(function() {
                    a(this).on("click", function() {
                        ...
                        var g;
                        d ? (b.removeClass("active"), g = c.ALL_ITEMS) : (b.addClass("active"), g = e), f.filter(g)
                    })
    ...
    }, c.bindValue = function() {
        a("[data-bind-radio]").each(function() {
            var b = a(this),
                c = b.data("bind-radio"),
                d = a('input[name="' + c + '"]:checked').val();
            b.text(b.dataAttr(d, b.text())), a('input[name="' + c + '"]').on("change", function() {
                var b = a('input[name="' + c + '"]:checked').val();
                a('[data-bind-radio="' + c + '"]').each(function() {
                    var c = a(this);
                    c.text(c.dataAttr(b, c.text()))
                })
            })
        })
